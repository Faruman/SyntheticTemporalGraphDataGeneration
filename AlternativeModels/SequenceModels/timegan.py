    ...
    def _train(self, data):
        ...
        for epoch in epoch_iterator:
            ...
            for X, T in train_dataloader:
                ...
                if self._wandb:
                    wandb.log({"Comb Supervisor Loss": self.err_d, "Comb Encoder & Decoder Loss": torch.mean(torch.stack(enc_dec_avg))})
...
class TIMEGANSynthesizer(LossValuesMixin, BaseSynthesizer):
    ...
    def sample(self, num_rows, num_entities= None, conditions= None):
        ...
        raise NotImplementedError("TIMEGANSynthesizer doesn't support conditional sampling.")
